...
////            stringRedisTemplate.opsForValue().set(RedisEnum.GZH_EWM_PREFIX + ticket, gzhOpenid,
// Duration.ofSeconds(280));
//            if ("subscribe".equals(eventType)) { // 如果是订阅消息
//                String subscribeContent = "感谢关注";
//                stringRedisTemplate.opsForValue().set(RedisConstant.WxToken+":"+ticket, gzhOpenid,
// Duration.ofSeconds(280));
//                return WxMessageUtil.getWxReturnMsg(resXml, subscribeContent);
//            }
//            if ("SCAN".equals(eventType)) { // 如果是扫码消息
//                String scanContent = "扫码成功";
////                stringRedisTemplate.opsForValue().set(RedisEnum.GZH_SAO_MA + ticket, "1",
// Duration.ofSeconds(280));
